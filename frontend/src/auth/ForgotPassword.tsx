...
const ForgotPassword = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-full">
            <form className="flex flex-col gap-5 md:p-8 w-full max-w-md rounded-lg mx-4 md:border border-gray-200 mx-4 shadow-sm">
                ...
                </div>
                {
                    loading ? (
                        ...
                        <Button className="bg-green hover:bg-hoverGreen">Send Reset Link</Button>
                    )
                }
